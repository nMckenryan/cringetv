...
CREATE TABLE "TV_Shows" (
    ...
    "aggregateCringeRating" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "Review" (
    "id" TEXT NOT NULL,
    "tvdbId" INTEGER NOT NULL,
    "cringeScore" DOUBLE PRECISION NOT NULL,
    "criticalRating" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "TV_Shows_tvdbId_key" ON "TV_Shows"("tvdbId");
